...
class IngredientCalculator:
    ...
    @cachedmethod(attrgetter('_calculation_cache'), key=lambda self, product_quantities: tuple(sorted(product_quantities.items())))
        ...
        def get_raw_ingredients_for_recipe(
            ...
            for ingredient in recipe.ingredients.values():
                ...
                if ingredient_name_lower in self.recipe_lookup:
                    ...
                    logger.info(
                        f"  Raw ingredient: {ingredient.name} = {ingredient_quantity_needed}{ingredient.unit.value}"
                    )
    ...
    @cachedmethod(attrgetter('_calculation_cache'), key=lambda self, remaining_servings: tuple(sorted(remaining_servings.items())))
